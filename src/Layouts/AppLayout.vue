...
const active = (url) => location.href.includes(url);
</script>
          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <JetNavLink href="/dashboard/about-us" :active="active('about-us')">
                  AboutUs
                </JetNavLink>
                <JetNavLink href="/dashboard/products" :active="active('products')">
                  Products
                </JetNavLink>
                <JetNavLink href="/dashboard/customers" :active="active('customers')">
                  Customers
                </JetNavLink>
                <JetNavLink href="/dashboard/social-account" :active="active('social-account')">
                  Social Account
                </JetNavLink>
                <JetNavLink href="/dashboard/image-slider" :active="active('image-slider')">
                  Image Slider
                </JetNavLink>
              </div>
            </div>
                ...
                <JetDropdown align="right" width="48">
                  <template #trigger>
                    ...
                    <span v-else class="inline-flex">
                      <button type="button"
                        class=" inline-flex items-center rounded-md px-3 py-2 border border-transparent text-sm leading-4 font-medium  hover:text-gray-300 hover:bg-gray-600 focus:outline-none transition">
        ...
        <div :class="{
          ...
          <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
              ...
              <JetResponsiveNavLink :href="route('about-us.index')">
                AboutUs
              </JetResponsiveNavLink>

              <JetResponsiveNavLink :href="route('image-slider.index')">
                Image Slider
              </JetResponsiveNavLink>

              <JetResponsiveNavLink :href="route('products.index')">
                Department
              </JetResponsiveNavLink>
              ...
              <JetResponsiveNavLink :href="route('social-account.index')">
                Social Account
              </JetResponsiveNavLink>
